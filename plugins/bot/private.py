"""
AndroidCaveMusic, Telegram Voice Chat Bot
...
HOME_TEXT = "👋🏻 **Hi [{}](tg://user?id={})**,\n\nI'm **AndroidCaveMusic** \nI Can Play Radio / Music / YouTube Live In Channel & Group 24x7 Nonstop. Made with ❤️ By @AlphaElias 😉!"
HELP_TEXT = """
💡 --**Setting Up**--:
...
async def start(client, message):
    ...
    reply_markup = InlineKeyboardMarkup(buttons)
    m=await message.reply_photo(photo="https://telegra.ph/file/8aa6bd49118a4eb0b9d25.jpg", caption=HOME_TEXT.format(message.from_user.first_name, message.from_user.id), reply_markup=reply_markup)
    await mp.delete(m)
...
async def help(client, message):
    ...
    msg['help'] = await message.reply_photo(photo="https://telegra.ph/file/8aa6bd49118a4eb0b9d25.jpg", caption=HELP_TEXT, reply_markup=reply_markup)
    await mp.delete(message)
